...
export const blogArticles: Section[] = [
  {
    ...
    links: [
      {
        href: "https://stackoverflow.com/questions/65280785/is-it-possible-to-declare-a-typescript-function-which-works-on-both-numbers-and#answer-65281351",
  ...
  // },
  {
    ...
    links: [
      {
        href: "https://stackoverflow.com/questions/65361696/arguments-of-same-length-typescript",
  ...
  },
  {
    ...
    links: [
      {
        href: "https://stackoverflow.com/questions/65476787/how-to-dynamically-create-an-object-based-on-a-readonly-tuple-in-typescript/65478618#65478618",
        text: "Typing arrays",
      },
      {
  ...
  },
  {
    ...
    links: [
      {
        href: "https://stackoverflow.com/questions/65533827/get-keys-of-an-interface-in-generics/65534971#65534971",
  ...
  },
  {
    ...
    links: [
      {
        href: "https://stackoverflow.com/questions/64899974/require-at-least-one-prop-to-be-passed-to-component-typescript",
        text: "Pass union props to React component - 1",
      },
      {
        href: "https://stackoverflow.com/questions/65805600/struggling-with-building-a-type-in-ts",
  ...
  },
  {
    ...
    links: [
      {
        href: "https://stackoverflow.com/questions/65540887/typescript-type-can-not-be-inferred-if-function-parameter-is-used/65543597#65543597",
        text: "Callback typings",
      },
      {
        href: "https://en.wikipedia.org/wiki/Type_system#:~:text=In%20programming%20languages%2C%20a%20type,%2C%20expressions%2C%20functions%20or%20modules.",
        text: "Type system",
      },
      {
      ...
      {
        href: "https://basarat.gitbook.io/typescript/type-system/type-compatibility",
        text: "TS book",
      },
      {
  ...
  },
  {
    ...
    links: [
      {
        href: "https://docs.google.com/presentation/d/1po3-zRQCp8m8cwg-CF5dUL_6RPe9gIaKIT5P_DNbGE8/edit#slide=id.g6baf2c25cf_0_33",
        text: "presentation",
      },
      {
        href: "http://cliffle.com/blog/rust-typestate/",
        text: "Cliff L. Biffle's blog",
      },
      {
        href: "https://stackoverflow.com/questions/65431379/type-property-relying-on-return-type-of-another-property",
...

  {
    ...
    description:
      "Here you can find some advanced examples with template literals",
  ...
  },
  {
    url: "/FP-style",
    title:
      "Functional programming. Typing compose and pipe functions in TypeScript",
  ...
  },
  {
    ...
    description:
      "Use rest operator one after another in tuple type representation",
    Comp: "RestTuples",
    links: [
      {
        href: "https://stackoverflow.com/questions/68700018/how-to-reuse-rest-types-in-tuples/68700643#68700643",
  ...
  },
  {
    ...
    description:
      "In this article you will learn how to validate template literal type of email string",
  ...
  },
  {
    ...
    description:
      "You will find how to invert key path and several functional patterns in React",
  ...
  },
  {
    ...
    description: "Utils for mapping interfaces",
    Comp: "Utils",
    links: [
      {
        text: "Naming convention transformers",
